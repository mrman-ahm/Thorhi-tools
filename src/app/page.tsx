...
const divisions = [
  { index: "01", name: "Surgical Instruments", description: "Scissors, forceps, clamps, retractors, suturing, and specialty surgery.", families: "Scissors · Forceps · Retractors", tone: "blue" },
  { index: "02", name: "Dental Instruments", description: "Diagnostic, extraction, restorative, periodontal, and orthodontic families.", families: "Extraction · Periodontal · Restorative", tone: "ice" },
